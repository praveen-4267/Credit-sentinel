...
df_loans = pd.read_csv("C:\\Users\\prave\\OneDrive\\Attachments\\Desktop\\CreditSentinel-Data\\loan_applications.csv")
df_bank  = pd.read_csv("C:\\Users\\prave\\OneDrive\\Attachments\\Desktop\\CreditSentinel-Data\\bank_statements.csv")
df_bur   = pd.read_csv("C:\\Users\\prave\\OneDrive\\Attachments\\Desktop\\CreditSentinel-Data\\bureau_data.csv")
df_gst   = pd.read_csv("C:\\Users\\prave\\OneDrive\\Attachments\\Desktop\\CreditSentinel-Data\\gst_filings.csv")
...
def compute_features_for_application(application_id: str) -> dict:
    ...
    """
    # Step A: Load all 4 CSVs using relative paths
    #         (works regardless of which machine runs the API)
    df_loans = pd.read_csv("C:\\Users\\prave\\OneDrive\\Attachments\\Desktop\\CreditSentinel-Data\\loan_applications.csv")
    df_bank  = pd.read_csv("C:\\Users\\prave\\OneDrive\\Attachments\\Desktop\\CreditSentinel-Data\\bank_statements.csv")
    df_bur   = pd.read_csv("C:\\Users\\prave\\OneDrive\\Attachments\\Desktop\\CreditSentinel-Data\\bureau_data.csv")
    df_gst   = pd.read_csv("C:\\Users\\prave\\OneDrive\\Attachments\\Desktop\\CreditSentinel-Data\\gst_filings.csv")
